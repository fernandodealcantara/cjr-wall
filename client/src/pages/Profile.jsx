function Profile() {
  return (
    <div className="grid place-items-center h-screen">
      <div className="bg-NIPCard grid overflow-hidden grid-cols-3 grid-rows-2 gap-1 h-auto">
        <div className="bg-NIP box m-[10vh] rounded-lg">1</div>
        <div className="bg-NIP box col-start-1 m-[8%] rounded-lg">2</div>
        <div className="bg-NIP box row-start-1 row-end-3 col-start-2 m-[8%] rounded-lg">3</div>
      </div>
    </div>
  )
}
